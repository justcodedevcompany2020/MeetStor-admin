...
const Moderators = React.lazy(() => import('./views/base/tables/Moderators'))
...
const SingleModerator = React.lazy(() => import('./components/singleModerator/index'))
...
const routes = [
  ...
  { path: '/base/moderators', name: 'Moderators', element: Moderators },
  { path: '/base/users', name: 'Moderators', element: Users },
